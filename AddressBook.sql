...
insert into address_book(firstname, lastname, address, city, state, zip, phone_no, email) values ('pavi', 'yadhav', 'Garden', 'Mumbra', 'Maha', 400612, 7738565536, 're@gmail.com'),('pushpa','yadhav','Wadi','Mumbai','Maha',4000003, 9819585533, 'zd@gmail.com');
...
describe My_Book;
update my_book set type = 'Family' where firstname = 'pavi';
select * from my_book;
